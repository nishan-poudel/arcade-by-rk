export const en = {
  ...
  scoreKeeper: {
    ...
    roundEntry: {
      ...
      subtitle: "Enter each player's call and tricks, one at a time",
      callLabel: 'Call',
      tricksLabel: 'Tricks',
      nowEntering: (name: string) => `Now entering: ${name}`,
      lockInButton: 'Lock In',
      unlockButton: 'Unlock',
      waitingTurn: 'Not yet entered',
      tricksMismatch: (total: number) => `All 4 are locked, but tricks add up to ${total}, not 13. Unlock one to fix it.`,
